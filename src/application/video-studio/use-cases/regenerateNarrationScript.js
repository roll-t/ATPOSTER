 ...
 */
export async function regenerateNarrationScript({ category, input, segments, apiKey, generateText }) {
  if (typeof generateText !== 'function') {
    throw new TypeError('regenerateNarrationScript requires a text-generation gateway.');
  }
