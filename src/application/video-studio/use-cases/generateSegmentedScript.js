...
export async function generateSegmentedScript({ category, durationRange, input, apiKey, generateText }) {
  if (typeof generateText !== 'function') {
    throw new TypeError('generateSegmentedScript requires a text-generation gateway.');
  }
