 ...
 */
export async function generatePublishMeta({ title, segments, isLandscape = true, apiKey, generateText }) {
  if (typeof generateText !== 'function') {
    throw new TypeError('generatePublishMeta requires a text-generation gateway.');
  }
  ...
  const raw = await generateText(prompt, keys, {
    tier: 'fast',
