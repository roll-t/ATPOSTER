 ...
 */
export async function translateSubtitleLines(englishLines, apiKeyOrKeys, generateText) {
  if (typeof generateText !== 'function') {
    throw new TypeError('translateSubtitleLines requires a text-generation gateway.');
  }
...
`;
  ...
  const result = await generateText(promptText, keys, { tier: 'fast', label: 'Dịch phụ đề' });
