...
export const PROMPT_CATEGORIES = {
    ...
    fields: [
      ...
      },
      {
        ...
        suggestions: [
          ...
          { text: 'Quá nhút nhát không dám phát biểu trong lớp (Too shy to speak up)', people: 1 },
          { text: 'Tiêu tiền vào những thứ không thực sự cần thiết (Spending money on useless things)', people: 1 },
          { text: 'Bỏ bữa sáng vì lúc nào cũng vội vàng (Skipping breakfast in a rush)', people: 1 },
          { text: 'Chật vật cân bằng giữa học tập và nghỉ ngơi (Struggling to balance study and rest)', people: 1 },
          { text: 'Cảm giác lo âu căng thẳng trước kỳ thi lớn (Feeling anxious before big exam)', people: 1 },
          { text: 'Thói quen hay than vãn thay vì hành động (Complaining instead of taking action)', people: 1 },
          { text: 'Bỏ bê sức khỏe cho đến khi quá muộn (Ignoring health until too late)', people: 1 },
          { text: 'Nỗi khổ sở khi phải dậy sớm mỗi sáng (Struggle of waking up early)', people: 1 },
          { text: 'Nghiện điện thoại trong giờ sinh hoạt gia đình (Addicted to phone in family time)', people: 2 },
          { text: 'Bỏ cuộc quá sớm mỗi khi gặp khó khăn (Giving up too quickly)', people: 1 },
          { text: 'Nỗi sợ mắc sai lầm trước mặt người khác (Fear of making mistakes)', people: 1 },
          { text: 'Quên uống đủ nước mỗi ngày (Forgetting to drink enough water)', people: 1 },
          { text: 'Vấn nạn bắt nạt và ảnh hưởng đến bạn học rụt rè (Bullying and shy classmate)', people: 2 },
          { text: 'Làm việc quá sức và quên mất việc nghỉ ngơi (Overworking and forgetting to rest)', people: 1 },
          { text: 'Luôn viện cớ thay vì kiên trì học tập mỗi ngày (Making excuses instead of learning)', people: 1 }
        ]
      },
  ...
  japanese_history: {
    ...
    icon: '⚔️',
    description: 'Kể một lát cắt lịch sử Nhật Bản có thật — 100% TIẾNG NHẬT (kèm dòng dịch tiếng Việt), có [tag] cảm xúc cho ElevenLabs v3. ĐẶC BIỆT: Tự động nhận diện đề tài chiến tranh/chiến trận để xuất prompt đại chiến hoành tráng (Epic Battle Art), loại bỏ kiểu tối giản làng quê. Ảnh luôn 16:9 ngang, đồng bộ tự động Google Flow. Kèm sẵn tiêu đề + hashtag tiếng Nhật và 2 prompt ảnh bìa (16:9 & 9:16).',
    fields: [
      {
        key: 'aspectRatio',
        label: 'Định dạng video (Tỉ lệ)',
      ...
      {
        key: 'visualTone',
        label: 'Phong cách & Không khí hình ảnh',
        type: 'select',
        required: false,
        defaultValue: 'auto',
        options: [
          { value: 'auto', label: '⚡ Tự động nhận diện (Chiến tranh -> Hoành tráng; Đời sống -> Cổ kính)' },
          { value: 'epic_war', label: '🔥 Chiến trận hoành tráng & Giao tranh khốc liệt (Epic Battle)' },
          { value: 'calm_zen', label: '🏯 Cổ kính, trang nghiêm & Đời sống (Tranh mực lịch sử)' }
        ]
      },
      {
        key: 'historyTheme',
