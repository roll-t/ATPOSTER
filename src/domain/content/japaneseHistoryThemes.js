...
export const JAPANESE_HISTORY_THEMES = [
  ...
  },
  {
    ...
    icon: '⚔️',
    accentColor: '#f43f5e',
    description: 'Võ sĩ đạo, lòng trung thành và cái giá của nó — đời sống và chiến trận thật của tầng lớp samurai.',
    story: 'Tell one samurai story through martial duty, steel discipline, and the warrior code (Bushidō). Show the warrior in action and resolution: unsheathed katanas, the intense martial focus before the strike, the heavy battle armor worn into combat, and the unwavering loyalty that commanded their lives. Ground it in historical reality: their true combat tactics, weapons, armor craft, and the battlefield stakes they faced.',
    motifs: 'an armored samurai commander with drawn katana and fierce focused gaze, a warrior adjusting the silk lacing of his heavy lacquered yoroi armor before battle, crossed katanas gleaming in torchlight, a mounted samurai on a warhorse at castle gates at dawn, ranks of samurai marching with clan crest banners snapping in wind, an ornate kabuto helmet with a gleaming crescent crest resting before an unrolled battle map',
    mood: 'Disciplined, fierce, and honorable — the martial gravitas and iron resolve of the samurai warrior.'
  },
  {
    key: 'ninja_shinobi',
    label: '忍者と忍びの術',
  ...
  },
  {
    ...
    story: 'Tell ONE named Sengoku event and stay inside it. Anchor it hard: the year, the province, the two sides, what each wanted. Detail the decisive tactical turns — the night mobilization through driving rain, the dawn cavalry charge, the clash of spear walls, the matchlock gunfire echoing through valleys, and the warlords directing troops with war fans. Give the outcome plainly with epic historical gravitas. Where popular legend differs from documented record, state both clearly.',
    motifs: 'armored samurai cavalry charging into battle with drawn katanas and fluttering sashimono clan banners, clashing frontlines of ashigaru locked spear-to-spear amidst billowing white gunsmoke, an imposing warlord commander atop a hill holding a gold-leaf war fan (gunbai) surrounded by bodyguards, flaming arrows arcing over stone castle ramparts, ranks of matchlock arquebusiers firing through wooden barricades, dramatic battlefield clash under stormy skies with flying embers and snapping war flags',
    mood: 'Epic, monumental and intense — the thunderous clash of rival armies and the fiery crucible of battle.'
  },
  {
    key: 'heroes_legacy',
    label: '英傑たちの功績',
