...
export const MORAL_THEMES = [
  ...
  // -----------------------------------------------------------------------------------------------
  {
    ...
    label: 'Top Trending TikTok',
    sub: 'Sách BookTok bán chạy',
    icon: '🔥',
    voice: 'book_pitch',
    group: 'book',
    styleLabel: 'Book Pitch: Viral TikTok / BookTok Bestsellers in Vietnam'
  },
  {
    key: 'book_discipline',
    label: 'Kỷ Luật & Thói Quen',
    sub: 'Atomic Habits & Bỏ trì hoãn',
    icon: '⚡',
    voice: 'book_pitch',
    group: 'book',
    styleLabel: 'Book Pitch: Habit Building, Atomic Habits & Beating Procrastination'
  },
  {
    key: 'book_psychology',
    label: 'Tâm Lý & Đọc Vị',
    sub: 'Đọc vị & Tâm lý học',
    icon: '🧠',
    voice: 'book_pitch',
    group: 'book',
    styleLabel: 'Book Pitch: Psychology, Behavioral Science & Reading People'
  },
  {
    key: 'book_finance',
    label: 'Tài Chính & Tiền Bạc',
    sub: 'Tư duy giàu & Giữ tiền',
    icon: '💰',
    voice: 'book_pitch',
    group: 'book',
    styleLabel: 'Book Pitch: Personal Finance, Money Psychology & Wealth Mindset'
  },
  {
    key: 'book_communication',
    label: 'Khéo Ăn Nói',
    sub: 'Giao tiếp & Đắc nhân tâm',
    icon: '🤝',
    voice: 'book_pitch',
    group: 'book',
    styleLabel: 'Book Pitch: Communication, People Skills & Social Intelligence'
  },
  {
    key: 'book_healing',
    label: 'Chữa Lành & Buông Bỏ',
    sub: 'Bình an & Chủ nghĩa khắc kỷ',
    icon: '🌿',
    voice: 'book_pitch',
    group: 'book',
    styleLabel: 'Book Pitch: Mental Health, Letting Go & Stoic Philosophy'
  },
  {
    key: 'book_mindset',
    label: 'Tư Duy Đột Phá',
    sub: 'Đổi đời & Nâng cấp bản thân',
    icon: '🚀',
    voice: 'book_pitch',
    group: 'book',
    styleLabel: 'Book Pitch: Growth Mindset, Life Design & Breaking Limits'
  },
  {
    key: 'book_focus',
    label: 'Tập Trung Sâu',
    sub: 'Cai điện thoại & Dopamine',
    icon: '📵',
    voice: 'book_pitch',
    group: 'book',
    styleLabel: 'Book Pitch: Digital Minimalism, Deep Work & Reclaiming Focus'
  },
  {
    key: 'book_business',
    label: 'Kinh Doanh & Bán Hàng',
    sub: 'Khởi nghiệp & Đàm phán',
    icon: '💼',
    voice: 'book_pitch',
    group: 'book',
    styleLabel: 'Book Pitch: Business Strategy, Sales Mastery & Negotiation'
  },
  {
    key: 'book_leadership',
    label: 'Lãnh Đạo & Quản Trị',
    sub: 'Dẫn dắt & Truyền cảm hứng',
    icon: '👑',
    voice: 'book_pitch',
    group: 'book',
    styleLabel: 'Book Pitch: Leadership, Management & Inspiring People'
  },
  {
    key: 'book_philosophy',
    label: 'Triết Lý Sống',
    sub: 'Nhân sinh quan sâu sắc',
    icon: '📜',
    voice: 'book_pitch',
    group: 'book',
    styleLabel: 'Book Pitch: Life Wisdom, Ancient Philosophy & Self-Reflection'
  }
];

export const DEFAULT_MORAL_THEME = 'self_help';
export const DEFAULT_BOOK_THEME = 'book_tiktok_trending';

export const MORAL_THEME_GROUPS = [
  { key: 'moral', label: '🗣️ Đạo Lý Cuộc Sống', sub: '26 nhóm bài học' },
  { key: 'book', label: '📚 Giới Thiệu Sách', sub: '11 nhóm sách bán chạy TikTok' }
];
...
// Nhãn tiếng Việt ngắn dùng cho nút "Lộ trình ... chủ đề (...)"
export function getMoralThemeLabel(themeKey) {
  return getMoralTheme(themeKey).label;
}

// Kiểm tra chủ đề thuộc nhóm Giới Thiệu Sách
export function isBookMoralTheme(themeKey) {
  const theme = getMoralTheme(themeKey);
  return theme.group === 'book' || theme.voice === 'book_pitch';
}

// Lọc danh sách nhóm chủ đề theo Tab ('moral' | 'book')
export function getMoralThemesByGroup(group = 'moral') {
  return MORAL_THEMES.filter((t) => (t.group || 'moral') === group);
}
...
/**
 * Giọng văn thô ('reflective' | 'list' | 'satire' | 'book_pitch').
 */
