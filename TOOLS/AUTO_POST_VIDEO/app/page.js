          ...
          onMouseLeave={(e) => {
            ...
            <div>
              ...
              <p style={{
                ...
                Biên dịch và kết xuất tự động các phân đoạn hình ảnh/âm thanh thành video Remotion chất lượng cao. Theo dõi hàng chờ xuất bản, tải xuống hoặc đồng bộ lên Google Drive.
              </p>
            </div>
            <div className="tool-btn" style={{
              marginTop: '24px',
