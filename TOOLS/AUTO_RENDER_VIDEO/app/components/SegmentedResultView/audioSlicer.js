...
/**
 * Tạo Blob WAV tĩnh lặng (16-bit PCM mono 44.1kHz).
 * Dùng cho các slide không có lời thoại (tiêu đề hồi chapter-title).
 */
export function createSilentWavBlob(durationSeconds = 3, sampleRate = 44100) {
  ...
  writeText(36, 'data');
  view.setUint32(40, count * 2, true);
  // Dữ liệu PCM trong ArrayBuffer mặc định đã là số 0 (hoàn toàn tĩnh lặng)
