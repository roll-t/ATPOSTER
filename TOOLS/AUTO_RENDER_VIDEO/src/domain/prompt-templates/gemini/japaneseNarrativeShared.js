import { CHARS_PER_SECOND_JA_SLOW } from '../../narration/speech-rate.js';
 ...
 */
export function sectionVisual({ worldOpeners, peopleExamples, worldList, themeBlock, compositionGuidance, isWar = false }) {
  return `────────────────────────────────────────
...
- For battlefield and military scenes: always illustrate armies, commanders, banners, and encampments in clear morning daylight or soft overcast noon with light distant mist. Never depict dark nocturnal battlefields or murky shadows.
...
- FOR WAR / BATTLE / CONQUEST TOPICS: Create a breathtaking, monumentally epic battlefield cover illustration! Depict an imposing armored samurai warlord in elaborate horned kabuto and fierce battle armor commanding in the foreground, or two massive clashing armies locked in combat, with billowing clan banners (nobori, hata-jirushi), burning castle watchtowers, gunsmoke, and fiery embers drifting under a dramatic stormy sky. Must strike the viewer immediately with grand martial scale and dramatic historical intensity!
