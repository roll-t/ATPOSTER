 ...
 */
export async function translateAndExpandInputs({ category, input, apiKey, generateText }) {
  if (typeof generateText !== 'function') {
    throw new TypeError('translateAndExpandInputs requires a text-generation gateway.');
  }
