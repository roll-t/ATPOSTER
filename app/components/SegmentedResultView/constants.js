...
export const BG_MUSIC_TRACKS = [
  { id: 'track1', name: 'Andriig Soft Ambient', shortName: 'Soft Ambient', desc: 'Êm ái, thư thái', file: '/audio/bg-music/default/track1.mp3' },
  { id: 'track2', name: 'Andriig Gentle Acoustic', shortName: 'Gentle Acoustic', desc: 'Sâu lắng, ấm áp', file: '/audio/bg-music/default/track2.mp3' },
  { id: 'track3', name: 'Moment of Peace', shortName: 'Moment of Peace', desc: 'Du dương, chữa lành', file: '/audio/bg-music/default/track3.mp3' }
];
