                ...
                return (
                  <>
                    ...
                    <p style={{ margin: '4px 0 0', fontSize: '0.8rem', color: 'var(--text-muted)' }}>
                      {isBook
                        ? `${themeTopics.length} kịch bản bán sách thực chiến (nỗi đau ➔ sách giải pháp ➔ bài học cốt lõi ➔ CTA). Bấm "Chọn chủ đề này" để dùng ngay.`
                        : `${themeTopics.length} bài học thực tế cho chủ đề đang chọn ở form. Đổi chủ đề ở ngoài form để xem lộ trình khác. Chủ đề đã tạo video sẽ được đánh dấu tích xanh ✓.`
                      }
                    </p>
                  </>
                );
