...
- `TOOLS/AUTO_POST_VIDEO`: publisher only — accounts, scheduling, browser upload, post metrics.
- `TOOLS/AUTO_RENDER_VIDEO`: studio only — generate scripts/assets, TTS, video rendering, Remotion skills.
